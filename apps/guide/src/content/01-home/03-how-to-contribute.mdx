...
To make a request, simply head over to [the repository's issue tracker](https://github.com/cyberpurge-net/discord.js/issues) and [create a new issue](https://github.com/cyberpurge-net/discord.js/issues/new)! Title it appropriately, and let us know exactly what you mean inside the issue description. Make sure that you've looked around the site before making a request; what you want to request might already exist!

<Alert title="Tip" type="success">
	Remember that you can always [fork the repository](https://github.com/cyberpurge-net/discord.js/fork) and [make a pull
	request](https://github.com/cyberpurge-net/discord.js/pulls) if you want to add anything to the guide yourself!
</Alert>
...
Throughout the guide, you'll see some components from the _`@cyberpurge-net/ui`_ package:
