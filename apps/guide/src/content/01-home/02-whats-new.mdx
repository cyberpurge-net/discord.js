...
We have moved from VuePress to [Next.js](https://nextjs.org/)! The source can be found [here](https://github.com/cyberpurge-net/discord.js/tree/main/apps/guide).

## Pages

All content has been updated to use discord.js v14 syntax. The v13 version of the guide can be found at https://v13.cyberpurge-net.guide.
...
- [Voice](/voice/): Rewritten to use the [_`@cyberpurge-net/voice`_](https://github.com/cyberpurge-net/discord.js/tree/main/packages/voice) package
