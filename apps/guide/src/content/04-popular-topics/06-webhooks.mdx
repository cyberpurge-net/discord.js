...
```js
channel
	.createWebhook({ name: 'Username', avatar: 'https://guide.cyberpurge-net.dev/assets/cyberpurge-net.png' })
...
```js
webhook
	.edit({ name: 'Username', avatar: 'https://guide.cyberpurge-net.dev/assets/cyberpurge-net.png', channel: '123456789012345678' })
...
await webhookClient.send({
	...
	avatarURL: 'https://guide.cyberpurge-net.dev/assets/cyberpurge-net.png',
	embeds: [embed],
});
```
