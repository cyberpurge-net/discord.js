...
If you previously had _`@cyberpurge-net/builders`_, _`@cyberpurge-net/formatters`_, _`@cyberpurge-net/rest`_, or _`discord-api-types`_ manually installed, it's _highly_ recommended that you uninstall the packages to avoid package version conflicts.

<CH.Code>

```sh npm
npm uninstall @cyberpurge-net/builders @cyberpurge-net/formatters @cyberpurge-net/rest discord-api-types
```

```sh yarn
yarn remove @cyberpurge-net/builders @cyberpurge-net/formatters @cyberpurge-net/rest discord-api-types
```

```sh pnpm
pnpm remove @cyberpurge-net/builders @cyberpurge-net/formatters @cyberpurge-net/rest discord-api-types
```
...
[^1]: https://github.com/cyberpurge-net/discord.js/pull/7188
[^2]: https://github.com/cyberpurge-net/discord.js/pull/6492
[^3]: https://github.com/cyberpurge-net/discord.js/pull/7669
[^4]: https://github.com/cyberpurge-net/discord.js/issues/6546
[^5]: https://github.com/cyberpurge-net/discord.js/pull/8010
[^6]: https://github.com/cyberpurge-net/discord.js/issues/7091
