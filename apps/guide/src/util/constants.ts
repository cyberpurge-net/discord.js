...
export const BASE_URL_LEGACY = 'https://old.cyberpurge-net.dev/#/docs/discord.js' as const;
...
export const GITHUB_BASE_PAGES_PATH = 'https://github.com/cyberpurge-net/discord.js/tree/main/apps/guide/src/pages';
