<div align="center">
	...
	<p>
		...
		<a href="https://www.npmjs.com/package/@cyberpurge-net/collection"><img src="https://img.shields.io/npm/v/@cyberpurge-net/collection.svg?maxAge=3600" alt="npm version" /></a>
		<a href="https://www.npmjs.com/package/@cyberpurge-net/collection"><img src="https://img.shields.io/npm/dt/@cyberpurge-net/collection.svg?maxAge=3600" alt="npm downloads" /></a>
		...
		<a href="https://codecov.io/gh/cyberpurge-net/discord.js" ><img src="https://codecov.io/gh/cyberpurge-net/discord.js/branch/main/graph/badge.svg?precision=2&flag=collection" alt="Code coverage" /></a>
	</p>
	<p>
...
`@cyberpurge-net/collection` is a powerful utility data structure used in discord.js.
...
```sh
npm install @cyberpurge-net/collection
yarn add @cyberpurge-net/collection
pnpm add @cyberpurge-net/collection
```
...
[source]: https://github.com/cyberpurge-net/discord.js/tree/main/packages/collection
[npm]: https://www.npmjs.com/package/@cyberpurge-net/collection
