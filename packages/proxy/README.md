<div align="center">
	...
	<p>
		...
		<a href="https://www.npmjs.com/package/@cyberpurge-net/proxy"><img src="https://img.shields.io/npm/v/@cyberpurge-net/proxy.svg?maxAge=3600" alt="npm version" /></a>
		<a href="https://www.npmjs.com/package/@cyberpurge-net/proxy"><img src="https://img.shields.io/npm/dt/@cyberpurge-net/proxy.svg?maxAge=3600" alt="npm downloads" /></a>
		...
		<a href="https://codecov.io/gh/cyberpurge-net/discord.js" ><img src="https://codecov.io/gh/cyberpurge-net/discord.js/branch/main/graph/badge.svg?precision=2&flag=proxy" alt="Code coverage" /></a>
	</p>
	<p>
...
`@cyberpurge-net/proxy` is a powerful wrapper around `@cyberpurge-net/rest` for running an HTTP proxy in front of Discord's API.
...
```sh
npm install @cyberpurge-net/proxy
yarn add @cyberpurge-net/proxy
pnpm add @cyberpurge-net/proxy
```
...
[source]: https://github.com/cyberpurge-net/discord.js/tree/main/packages/proxy
[npm]: https://www.npmjs.com/package/@cyberpurge-net/proxy
