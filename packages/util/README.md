...
`@cyberpurge-net/util` is a collection of utility functions for use with discord.js.
...
```sh
npm install @cyberpurge-net/util
yarn add @cyberpurge-net/util
pnpm add @cyberpurge-net/util
```
...
[source]: https://github.com/cyberpurge-net/discord.js/tree/main/packages/util
[npm]: https://www.npmjs.com/package/@cyberpurge-net/util
