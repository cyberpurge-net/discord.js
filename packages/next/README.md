...
```sh
npm install @cyberpurge-net/next
yarn add @cyberpurge-net/next
pnpm add @cyberpurge-net/next
```
...
[source]: https://github.com/cyberpurge-net/discord.js/tree/main/packages/next
[npm]: https://www.npmjs.com/package/@cyberpurge-net/next
