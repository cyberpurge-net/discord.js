...
/**
 * Methods that are provided by the \@cyberpurge-net/voice library to implementations of
...
export interface DiscordGatewayAdapterImplementerMethods {
	/**
	 * This will be called by \@cyberpurge-net/voice when the adapter can safely be destroyed as it will no
	 * longer be used.
	 */
	destroy(): void;
	/**
